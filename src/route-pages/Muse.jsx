...
function Muse() {
    ...
    const getResponse = async () => {
        ...
        try {
            const response = await fetch("http://127.0.0.1:5000/api/muse/muse", {
                method: "POST",
                headers: {
        ...
        <div className='px-[18%] pt-20 w-full flex items-center justify-center flex-col font-baloo'>
            ...
            <div className='font-bold mb-8 flex items-center gap-2 justify-between flex-col text-center'>
                <div className='flex items-center gap-2'>
                    ...
                    <span className='text-3xl'>MUSE</span>
                </div>
                <p className='opacity-75 text-xl'>Adapts to you and evolves</p>
            </div>
